            ...
            <Scene key='root' hideNavBar>
              <Scene hideNavBar hideTabBar type={ActionConst.RESET} key={Constants.LOGIN} component={LoginConnector} title='login' animation={'fade'} duration={600} initial username={this.props.username} />
                ...
                <Scene hideNavBar hideTabBar key={Constants.EDGE} component={LayoutConnector} routes={routes} animation={'fade'} duration={600}>
                  ...
                  <Scene key='tabRoutes' tabs>
                    <Scene hideNavBar hideTabBar key={Constants.WALLET_LIST} component={WalletList} title='Wallets' animation={'fade'} duration={600} initial/>
                    <Scene hideNavBar hideTabBar key={Constants.SCAN}        component={Scan}       title='Scan'    animation={'fade'} duration={600} />
                    <Scene hideNavBar hideTabBar key={Constants.REQUEST}     component={Request}    title='Request' animation={'fade'} duration={600} />
                    <Scene hideNavBar hideTabBar key={Constants.TRANSACTION_LIST}    component={TransactionListConnector} title='Transactions'        animation={'fade'} duration={600} />
                  </Scene>
